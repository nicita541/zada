...
export const en = {
  ...
  today: {
    ...
    searchResults: "{count} tasks found",
    previewDue: "Due: {date}",
    noTasks: "No tasks today",
    noTasksDescription: "You can rest or add a new task.",
    nothingFound: "Nothing found",
    nothingFoundDescription: "Try changing the search or filters.",
    noUpcoming: "No upcoming tasks",
    inboxEmpty: "Inbox is empty",
    inboxEmptyDescription: "New tasks without a project will appear here.",
  ...
  projects: {
    ...
    addTask: "Add task",
    projectNoTasks: "No tasks in this project",
    projectNoTasksDescription: "Add the first task to the project list or board.",
    noMatchingTasks: "No project tasks found",
    columns: {
      ideas: "Ideas",
      backlog: "Backlog",
      todo: "Todo",
  ...
  taskDetail: {
    ...
    emptyRemindersDescription: "Add a reminder so you do not forget this task.",
    repeat: "Repeat",
