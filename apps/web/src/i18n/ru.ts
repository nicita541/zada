...
export const ru = {
  ...
  today: {
    ...
    searchResults: "Найдено задач: {count}",
    previewDue: "Срок: {date}",
    noTasks: "Сегодня задач нет",
    noTasksDescription: "Можно отдохнуть или добавить новую задачу.",
    nothingFound: "Ничего не найдено",
    nothingFoundDescription: "Попробуйте изменить запрос или фильтры.",
    noUpcoming: "Нет будущих задач",
    inboxEmpty: "Входящие пусты",
    inboxEmptyDescription: "Новые задачи без проекта появятся здесь.",
  ...
  projects: {
    ...
    addTask: "Добавить задачу",
    projectNoTasks: "В проекте пока нет задач",
    projectNoTasksDescription: "Добавьте первую задачу в список или на доску проекта.",
    noMatchingTasks: "Задачи проекта не найдены",
    columns: {
      ideas: "Идеи",
      backlog: "Бэклог",
      todo: "К выполнению",
  ...
  taskDetail: {
    ...
    emptyRemindersDescription: "Добавьте напоминание, чтобы не забыть задачу.",
    repeat: "Повтор",
